        ...
        <div className="font-custom max-w-screen-lg mx-auto gap-8 lg:px-[6rem] md:px-[6rem]">
          <div className="flex flex-col gap-4">
			...
			{session_user === "specialist" || session_user === "admin" ? (
              ...
              <Button
                className="hover:bg-[#087b9b] hover:text-white text-md md:text-lg shadow-xl font-extrabold px-4 py-2 inline-block"
                onClick={() =>
                  (window.location.href =
                    "mailto:grupotunawainan@gmail.com?subject=Solicitud para crear posts&body=Coloque su usuario y escriba la razón del porqué quiere crear un post en la página.")
                }
              >
