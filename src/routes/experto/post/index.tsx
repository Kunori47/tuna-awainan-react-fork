							...
							<div className=" my-8 flex justify-between ">
								...
								{session_user === "specialist" || session_user === "admin" ? (
									...
									<Button className="w-1/6 hover:bg-[#087b9b] min-w-fit">
										<a className="" href="mailto:grupotunawainan@gmail.com?subject=Solicitud para crear posts&body=Coloque su usuario y escriba la razón del porqué quiere crear un post en la página.">
											Solicitud para crear un post
										</a>
									</Button>
								)}		
							</div>
