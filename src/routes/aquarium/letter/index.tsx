    ...
    return (<div>
        <LayoutAquarium></LayoutAquarium>
        {
            aquarium && aquarium.map((item) => (
                <Link to="/aquarium/letter/$letterid" className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 ml-8 mt-10" params={{ letterid: item.id }}>
